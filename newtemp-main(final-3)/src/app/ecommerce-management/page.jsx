...
import img1 from "/public/images/amazonprivate.jpeg";
import img2 from "/public/images/amazonwholesale.jpeg";
import tiktokImg from "/public/images/tiktok.jpeg";
import shopifyImg from "/public/images/shopify.jpeg";
          ...
          <div className="flex flex-col items-center pb-20 text-center">
              ...
              <div className="size-full">
                <div className="flex flex-1 flex-col tablet:flex-row">
                  ...
                  <div className="flex w-full flex-col justify-center space-y-4  py-10 text-left tablet:w-[50%] tablet:px-10">
                    ...
                    <Link
                      href="/ecommerce-management/amazon-privatelabel"
                      className="inline-block max-w-fit bg-pri_yellow px-4 py-2 text-lg font-bold tracking-wider text-pri_black transition-all duration-200 hover:bg-yellow-400"
                    >
                      LEARN MORE
                    </Link>
                  </div>
                ...
                <div className="flex flex-1 flex-col-reverse tablet:flex-row">
                  <div className="flex w-full flex-col justify-center space-y-4 py-10  text-left tablet:w-[50%] tablet:px-10">
                    ...
                    <Link
                      href="/ecommerce-management/amazon-wholesale"
                      className="inline-block max-w-fit bg-pri_yellow px-4 py-2 text-lg font-bold tracking-wider text-pri_black transition-all duration-200 hover:bg-yellow-400"
                    >
                      LEARN MORE
                    </Link>
              ...
              <div className="size-full">
                <div className="flex flex-1 flex-col tablet:flex-row">
                  ...
                  <div className="flex w-full flex-col justify-center space-y-4  py-10 text-left tablet:w-[50%] tablet:px-10">
                    ...
                    <Link
                      href="/ecommerce-management/tiktok-shop"
                      className="inline-block max-w-fit bg-pri_yellow px-4 py-2 text-lg font-bold tracking-wider text-pri_black transition-all duration-200 hover:bg-yellow-400"
                    >
                      LEARN MORE
                    </Link>
                ...
                <div className="flex flex-1 flex-col-reverse tablet:flex-row">
                  <div className="flex w-full flex-col justify-center space-y-4 py-10  text-left tablet:w-[50%] tablet:px-10">
                    ...
                    <Link
                      href="/ecommerce-management/shopify-whitelabel"
                      className="inline-block max-w-fit bg-pri_yellow px-4 py-2 text-lg font-bold tracking-wider text-pri_black transition-all duration-200 hover:bg-yellow-400"
                    >
                      LEARN MORE
                    </Link>
            ...
            <div className="flex flex-1 flex-col tablet:flex-row">
              ...
              <div className="flex w-full flex-col justify-center space-y-4  py-10 text-left tablet:w-[50%] tablet:px-10">
                ...
                <Link
                      href="/ecommerce-management/shopify-privatelabel"
                      className="inline-block max-w-fit bg-pri_yellow px-4 py-2 text-lg font-bold tracking-wider text-pri_black transition-all duration-200 hover:bg-yellow-400"
                    >
                      LEARN MORE
                    </Link>
